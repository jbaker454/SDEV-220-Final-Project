...
def main_menu_UI(window):
    ...
    mainToInventoryButton.bind("<Button-1>", lambda event, newMenu="inventorymenuFrame": Event_Reciever.change_menu(newMenu))
...
def inventory_menu_UI(window):
    ...
    inventoryToMainButton.bind("<Button-1>", lambda event, newMenu="mainMenuFrame": Event_Reciever.change_menu(newMenu))
    ...
    inventoryToShipmentButton.bind("<Button-1>", lambda event, newMenu="shipmentMenuFrame": Event_Reciever.change_menu(newMenu))
    ...
    inventoryToOrderButton.bind("<Button-1>", lambda event, newMenu="orderMenuFrame": Event_Reciever.change_menu(newMenu))
...
def shipment_menu_UI(window):
    ...
    shipmentToInventoryButton.bind("<Button-1>", lambda event, newMenu="inventorymenuFrame": Event_Reciever.change_menu(newMenu))

    shipmentAddButton = widgets.Widget.get_instance(widgets.Widget,"shipmentAddButton")
    shipmentAddButton  = widgets.CustomButton(
           name="shipmentAddButton", parent=shipmentMenuFrame, size=[10,2], 
           config=widgets.Config.getCustomConfigByName(widgets.Config,"Yellow"), **{"text":"Add Shipment"})
    shipmentAddButton.place(x=450,y=485)
...
def order_menu_UI(window):
    ...
    orderToInventory.bind("<Button-1>", lambda event, newMenu="inventorymenuFrame": Event_Reciever.change_menu(newMenu))

    orderAddButton = widgets.Widget.get_instance(widgets.Widget,"orderAddButton")
    orderAddButton  = widgets.CustomButton(
